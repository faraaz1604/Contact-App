...
public class signup extends AppCompatActivity {
    ...
    public void registerbuttonclick(View view) {
        ...
        String phonenumber_ = password_var.getEditText().getText().toString();
        ...
        if (!fullname_.isEmpty()) {
                    ...
                    if (!phonenumber_.isEmpty()) {
                        ...
                        if (!password_.isEmpty()) {
                            ...
                            if (email_.matches("^[_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$")){
                                ...
                                String phonenumber_s = password_var.getEditText().getText().toString();
                            ...
                            password_var.setError("password enter kar be");
                        }
            ...
            fullname_var.setError("please enter your fullname");
        }
